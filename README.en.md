...
| ✏️ Basic formatting | Three heading levels, bold, italic, center, ordered/unordered lists |
...
| 🛡️ Command protection | `\cite`, `\ref`, and other reference commands preserved verbatim |
| 🖼️ Image insertion | Enter a path to generate the `figure` float environment |
